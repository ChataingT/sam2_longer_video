...
class VideoProcessor:
    ...
    def full_video_propagate():
        """
        Reset the model and load the different prompt. Run the full propagation. Optimised for longue video
        """

    def propagate_for_small_nbr_of_frame():
        """
        Used to propagate to a small number of frame. More agile but less optimised for memory consumption.
        """
